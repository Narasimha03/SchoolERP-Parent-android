...
public class ProfileModuleTabsFragment extends Fragment {
    View timeTableView;
    TabLayout tabLayout;
    Toolbar toolbar;
    ViewPager viewPager;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        timeTableView = inflater.inflate(R.layout.profile_module_tabs_layout, container, false);
        tabLayout = timeTableView.findViewById(R.id.tab_layout);
        viewPager = timeTableView.findViewById(R.id.viewPager);

       /* toolbar = timeTableView.findViewById(R.id.toolbar);
        toolbar.setTitle("Profile");
        toolbar.setTitleTextColor(getResources().getColor(R.color.white));*/

        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getFragmentManager());

        StudentProfileShowFragment studentProfileShow = new StudentProfileShowFragment();
        viewPagerAdapter.addFrag(studentProfileShow, "Student Profile");
        ...
        StudentProfileAttendanceOnlyGraphFragment studentProfileAttendanceOnlyGraphFragment=new StudentProfileAttendanceOnlyGraphFragment();

        viewPagerAdapter.addFrag(studentProfileAttendanceOnlyGraphFragment, "Graphs");
